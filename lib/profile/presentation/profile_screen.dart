  ...
  Widget build(BuildContext context) {
    ...
    body: BlocConsumer<MainCubit, MainCubitStates>(
      listener: (context, state) {
        if(state is MainUpdateAccountSuccessState){
          showSnackBar(context, StringsManager.profileUpdated);
        }
      },
        ...
        child: Column(
          children: [
            ...
            DefaultButton(
              ...
              isLoading: state is MainUpdateAccountLoadingState,
              onPressed: (){
            ...
            DefaultButton(
              ...
              isLoading: state is MainDeleteAccountLoadingState,
