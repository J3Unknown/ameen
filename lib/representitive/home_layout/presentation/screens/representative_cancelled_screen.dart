                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${AppLocalizations.translate(StringsManager.cancelledTime)}: ${DateFormat('EEE dd, MMM, yyyy').format(DateTime.now())}', style: Theme.of(context).textTheme.titleLarge!.copyWith(color: ColorsManager.DARK_GREY)), //TODO: change the date into today's date
                      Text(AppLocalizations.translate('Cancelled by Admin or User or Agent'), style: Theme.of(context).textTheme.titleLarge!.copyWith(color: ColorsManager.DARK_GREY)), //TODO: change the date into today's date and check if this text is constant or status based
                    ],
                  ),
                ),
